...
def get_5_searchforyourfile(page: int, lang: str, parents: int, q: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Number of results to return per page.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/search/"
    querystring = {'page': page, 'lang': lang, 'parents': parents, 'q': q, 'page_size': page_size, }
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "kloudless-meeting-scheduler.p.rapidapi.com"
        }
...
def getalistofallaccounts(page: int, enabled: int, page_size: int, admin: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Retrieves only admin/non-admin accounts, if present.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/"
    querystring = {'page': page, 'enabled': enabled, 'page_size': page_size, 'admin': admin, }
...
def get_3_enableeventsendpoint(page_size: int, cursor: str, is_from: int, until: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
An ISO-8601 string specifying the latest time prior to which to return events (exclusive). Must be used along with `from`. Non-overlapping queries can be performed since the event times are in the range [`from`, `until`). Future cursor values returned are limited in range to the `until` value provided in the first request.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/events"
    querystring = {'page_size': page_size, 'cursor': cursor, 'from': is_from, 'until': until, }
...
Which page of items to retrieve.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/folders/root/contents/"
...
def get_2_downloadafile_scontents(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/contents/"
    querystring = {}
...
def getpermissionsforafile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/permissions/"
    querystring = {}
...
String specifier for thumbnail format 'png' or 'jpeg'.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/thumbnail/"
...
Retieve only active or only inactive links if present.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/properties"
...
Retrieves only an active/inactive link, if present.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/links/$LINK_ID/"
...
def getalistofitemsinafolder(page: int, recursive: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Number of items to return per page.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/contents/"
    querystring = {'page': page, 'recursive': recursive, 'page_size': page_size, }
...
def linkstothefolderattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/links/"
    querystring = {}
...
def listlinkscreatedforthisaccount(active: int, ordering: int, page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
A page number within the paginated result set.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/links"
    querystring = {'active': active, 'ordering': ordering, 'page_size': page_size, 'page': page, }
...
def getpropertiesforallservices(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/public/services/"
    querystring = {}
...
Number of objects in each page. For some services, the page_size isn’t respected. The `page_size` must be between `1` and `1000`.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/cal/calendars"
...
def retrieveacalendar(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID"
    querystring = {}
...
def getinfoaboutaspecificaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me"
    querystring = {}
...
def getmetadataaboutafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/"
    querystring = {}
...
def linkstothefileattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/links/"
    querystring = {}
...
def retrievetaskstatus(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/me/tasks/$TASK_ID"
    querystring = {}
...
def retrieveanevent(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events/$EVENT_ID"
    querystring = {}
...
def retrievelatestcursor(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/events/latest"
    querystring = {}
...
def getpermissionsforafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/permissions/"
    querystring = {}
...
A page number within the paginated result set.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/storage/quota/"
...
def retrievealead(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/leads/$LEAD_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/leads/"
    querystring = {'page_size': page_size, 'page': page, }
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/campaigns/"
    querystring = {'page_size': page_size, 'page': page, }
...
Filter by associated `account_id`. Note: this is only supported in `hubspot`
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/opportunites/"
...
def retrieveanopportunity(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/opportunities/$OPPORTUNITY_ID/"
    querystring = {}
...
def retrieveacampaign(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/campaigns/$CAMPAIGN_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/accounts"
    querystring = {'page_size': page_size, 'page': page, }
...
def getpropertiesforoneservice(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/public/services/$SERVICE_ID"
    querystring = {}
...
def retrieveanobject(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/objects/$OBJECT_ID/"
    querystring = {}
...
def retrieveanaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/accounts/$ACCOUNT_ID/"
    querystring = {}
...
def retrieveatask(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/tasks/$TASK_ID/"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/tasks/"
    querystring = {'page': page, 'page_size': page_size, }
...
ISO 8601 timestamp indicating the end of the range of events to retrieve, by event end time. Required by Outlook Calendar. The default value is the current UTC time.
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events"
...
def retrieveacontact(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/contacts/$CONTACT_ID/"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/objects/"
    querystring = {'page': page, 'page_size': page_size, }
...
def getmetadataaboutaspecficfile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/me/storage/files/$FILE_ID/"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-meeting-scheduler.p.rapidapi.com/accounts/me/crm/contacts/"
