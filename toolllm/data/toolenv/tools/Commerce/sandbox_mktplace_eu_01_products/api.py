...
def listofattributeandvalueoptions(action: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
def listcategoriesandsub_categories(action: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "API Instructions:  https://www.mktplace.eu/api-instructions-i-32.html
