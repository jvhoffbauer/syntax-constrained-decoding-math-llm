...
def get_random_quotes(count: int, category: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://famous-quotes4.p.rapidapi.com/random"
...
def list_categories(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://famous-quotes4.p.rapidapi.com/"
    querystring = {}
