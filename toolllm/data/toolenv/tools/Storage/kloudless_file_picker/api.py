...
def get_2_downloadafile_scontents(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/contents/"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "kloudless-file-picker.p.rapidapi.com"
        }
...
def getpermissionsforafile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/permissions/"
    querystring = {}
...
def get_5_searchforyourfile(lang: str, q: int, parents: int, page: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Number of results to return per page.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/search/"
    querystring = {'lang': lang, 'q': q, 'parents': parents, 'page': page, 'page_size': page_size, }
...
def get_3_enableeventsendpoint(cursor: str, page_size: int, until: int, is_from: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
An ISO-8601 string specifying the time of the oldest event in the range to return (inclusive). Can be used without `until`.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/events"
    querystring = {'cursor': cursor, 'page_size': page_size, 'until': until, 'from': is_from, }
...
def getalistofallaccounts(page_size: int, page: int, admin: int, enabled: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Retrieves only enabled/disabled accounts, if present.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/"
    querystring = {'page_size': page_size, 'page': page, 'admin': admin, 'enabled': enabled, }
...
def getpropertiesforoneservice(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/public/services/$SERVICE_ID"
    querystring = {}
...
def getpermissionsforafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/permissions/"
    querystring = {}
...
def get_1_getalistofitemsintherootfolder(page: int, page_size: int, recursive: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
List all contents within this folder.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/folders/root/contents/"
...
String specifier for thumbnail format 'png' or 'jpeg'.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/thumbnail/"
...
def linkstothefileattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/links/"
    querystring = {}
...
Number of objects on each page. The `page_size` must be between `1` and `1000`.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/properties"
...
def getinfoaboutaspecificaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me"
    querystring = {}
...
def retrievetaskstatus(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/me/tasks/$TASK_ID"
    querystring = {}
...
def getalistofitemsinafolder(page_size: int, page: int, recursive: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
List all contents within this folder.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/contents/"
    querystring = {'page_size': page_size, 'page': page, 'recursive': recursive, }
...
def getpropertiesforallservices(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/public/services/"
    querystring = {}
...
Retrieves only an active/inactive link, if present.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/links/$LINK_ID/"
...
def getmetadataaboutaspecficfile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/me/storage/files/$FILE_ID/"
    querystring = {}
...
Number of objects in each page. For some services, the page_size isn’t respected. The `page_size` must be between `1` and `1000`.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/cal/calendars"
...
def retrievelatestcursor(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/events/latest"
    querystring = {}
...
def listlinkscreatedforthisaccount(ordering: int, page_size: int, page: int, active: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
A page number within the paginated result set.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/links"
    querystring = {'ordering': ordering, 'page_size': page_size, 'page': page, 'active': active, }
...
def linkstothefolderattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/links/"
    querystring = {}
...
def retrieveanaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/accounts/$ACCOUNT_ID/"
    querystring = {}
...
def retrieveanevent(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events/$EVENT_ID"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/contacts/"
...
def getmetadataaboutafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/"
    querystring = {}
...
def listevents(end: int, start: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "The response contains the following information:
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events"
    querystring = {'end': end, 'start': start, 'page': page, }
...
def retrieveanopportunity(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/opportunities/$OPPORTUNITY_ID/"
    querystring = {}
...
def retrieveacalendar(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID"
    querystring = {}
...
def getusagequotadataforaserviceaccount(page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
A page number within the paginated result set.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/storage/quota/"
...
Default: 100
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/accounts"
    querystring = {'page': page, 'page_size': page_size, }
...
def retrieveacontact(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/contacts/$CONTACT_ID/"
    querystring = {}
...
def listallleads(page: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Default: 100
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/leads/"
    querystring = {'page': page, 'page_size': page_size, }
...
Filter by associated `account_id`. Note: this is only supported in `hubspot`
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/opportunites/"
...
def retrievealead(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/leads/$LEAD_ID/"
    querystring = {}
...
def retrieveacampaign(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/campaigns/$CAMPAIGN_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/campaigns/"
    querystring = {'page_size': page_size, 'page': page, }
...
def retrieveatask(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/tasks/$TASK_ID/"
    querystring = {}
...
def retrieveanobject(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/objects/$OBJECT_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/tasks/"
    querystring = {'page_size': page_size, 'page': page, }
...
Default: 100
    ...
    """
    url = f"https://kloudless-file-picker.p.rapidapi.com/accounts/me/crm/objects/"
    querystring = {'page': page, 'page_size': page_size, }
