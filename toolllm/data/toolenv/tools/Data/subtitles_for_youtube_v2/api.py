...
def download_mp3(videoid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Download mp3 from youtube video."
    videoid: Youtube Video ID
        
    """
    url = f"https://subtitles-for-youtube2.p.rapidapi.com/download_mp3/{videoid}"
    querystring = {}
...
def list_all_available_subtitles(videoid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://subtitles-for-youtube2.p.rapidapi.com/subtitles/{videoid}/list"
    querystring = {}
...
def list_languages(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://subtitles-for-youtube2.p.rapidapi.com/subtitles/languages"
    querystring = {}
...
def get_subtitle_in_json_format(videoid: str, translated: str=None, lang: str=None, type: str=None, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://subtitles-for-youtube2.p.rapidapi.com/subtitles/{videoid}"
    querystring = {}
    if translated:
...
def get_subtitle_in_srt_format(videoid: str, type: str=None, lang: str=None, translated: str=None, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://subtitles-for-youtube2.p.rapidapi.com/subtitles/{videoid}/srt"
    querystring = {}
    if type:
        querystring['type'] = type
    if lang:
