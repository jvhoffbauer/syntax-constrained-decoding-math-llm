...
def directions_between_2_locations(end_lon: int, end_lat: int, start_lon: int, start_lat: int, distance_unit: str='km', toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://ghana-api.p.rapidapi.com/directions"
    querystring = {'end_lon': end_lon, 'end_lat': end_lat, 'start_lon': start_lon, 'start_lat': start_lat, }
    if distance_unit:
...
def measure_distance(lon1: int, lat2: int, lat1: int, lon2: int, unit: str='km', toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://ghana-api.p.rapidapi.com/distance"
    querystring = {'lon1': lon1, 'lat2': lat2, 'lat1': lat1, 'lon2': lon2, }
    if unit:
...
def reverse_geocode(lon: str, lat: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "This endpoint allows you to perform reverse geocoding in Ghana by providing query parameters for latitude and longitude. It returns the name of the city where the location is located."
    lon: The longitude of the location.
        lat: The latitude of the location.
        
    """
    url = f"https://ghana-api.p.rapidapi.com/georev"
...
def facilities_lookup(region: str, type: str, limit: int=10, city: str='Accra', toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "This endpoint allows you to get facilities in Ghana like hospital, bank, college, etc. by providing optional query parameters for facility type, region and city. It returns a list of facilities that match the query parameters."
...
[More options->](https://wiki.openstreetmap.org/wiki/Map_features#Amenity)
    ...
    """
    url = f"https://ghana-api.p.rapidapi.com/facility"
...
def geocode(address: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "This endpoint allows you to lookup locations in Ghana by providing an address query parameter. It returns the latitude, longitude and city name of the location."
    address: Name of address to lookup
        
    """
    url = f"https://ghana-api.p.rapidapi.com/geofy"
