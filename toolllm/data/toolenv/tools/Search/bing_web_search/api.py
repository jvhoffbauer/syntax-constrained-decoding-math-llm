...
def supported_countries(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "You can search against these countries."
    
    """
    url = f"https://bing-web-search4.p.rapidapi.com/supported-regions"
    querystring = {}
...
def supported_languages(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "These languages are supported for to search."
    
    """
    url = f"https://bing-web-search4.p.rapidapi.com/supported-languages"
    querystring = {}
