...
def get_all_covid_news(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://covid-news2.p.rapidapi.com/news"
    querystring = {}
...
def get_covid_news_from_specific_outlet(newspaperid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "This endpoint will return news from specific news outlets"
    
    """
    url = f"https://covid-news2.p.rapidapi.com/news/{newspaperid}"
    querystring = {}
