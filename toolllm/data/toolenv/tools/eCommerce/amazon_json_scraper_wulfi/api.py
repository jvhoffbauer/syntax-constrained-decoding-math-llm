...
def get_product_offers(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-json-scraper-wulfi.p.rapidapi.com/products/{productid}/offers"
    querystring = {'api_key': api_key, }
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "amazon-json-scraper-wulfi.p.rapidapi.com"
        }
...
def get_product_details(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Get the details of a product from an Amazon"
    
    """
    url = f"https://amazon-json-scraper-wulfi.p.rapidapi.com/products/{productid}"
    querystring = {'api_key': api_key, }
...
def get_amazon_search_results(searchquery: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-json-scraper-wulfi.p.rapidapi.com/search/{searchquery}"
    querystring = {'api_key': api_key, }
