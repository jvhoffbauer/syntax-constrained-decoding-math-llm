...
def get_search_results(searchquery: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-product-data-scraper2.p.rapidapi.com/search/{searchquery}"
    querystring = {'api_key': api_key, }
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "amazon-product-data-scraper2.p.rapidapi.com"
        }
...
def get_product_reviews(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "**Extract all customer reviews & rating  of the product**"
    
    """
    url = f"https://amazon-product-data-scraper2.p.rapidapi.com/products/{productid}/reviews"
    querystring = {'api_key': api_key, }
