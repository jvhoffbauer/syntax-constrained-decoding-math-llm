...
def search_query(searchquery: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Search query"
    
    """
    url = f"https://amazon-data-scraper58.p.rapidapi.com/search/{searchquery}"
    querystring = {}
...
def get_amazon_product_offers(productid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper58.p.rapidapi.com/products/{productid}/offers"
    querystring = {}
...
def get_amazon_product_reviews(productid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper58.p.rapidapi.com/products/{productid}/reviews"
    querystring = {}
...
def get_amazon_product_details(productid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper58.p.rapidapi.com/products/{productid}"
    querystring = {}
