...
def get_amazon_search_results(searchquery: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "It Will Give The Product Details You Want Just By Searching The Product Name."
    
    """
    url = f"https://ag-amazon-data-web-scraper.p.rapidapi.com/search/{searchquery}"
    querystring = {}
...
def get_amazon_product_reviews(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "It Helps You To Get Reviews Of Any Product By Entering Its Product Id."
    
    """
    url = f"https://ag-amazon-data-web-scraper.p.rapidapi.com/products/{productid}/reviews"
