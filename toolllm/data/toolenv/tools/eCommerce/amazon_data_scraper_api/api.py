...
def get_amazon_product_offers(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper-api2.p.rapidapi.com/products/{productid}/offers"
...
def get_amazon_search_results(searchquery: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper-api2.p.rapidapi.com/search/{searchquery}"
    querystring = {'api_key': api_key, }
...
def get_amazon_product_details(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-data-scraper-api2.p.rapidapi.com/products/{productid}"
    querystring = {'api_key': api_key, }
