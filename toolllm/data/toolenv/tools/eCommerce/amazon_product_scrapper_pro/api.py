...
def get_amazon_product_reviews(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-product-scrapper-pro.p.rapidapi.com/products/{productid}/reviews"
...
def get_amazon_product_offers(productid: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-product-scrapper-pro.p.rapidapi.com/products/{productid}/offers"
    querystring = {'api_key': api_key, }
...
def get_amazon_search_results(searchquery: str, api_key: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://amazon-product-scrapper-pro.p.rapidapi.com/search/{searchquery}"
    querystring = {'api_key': api_key, }
