...
def get_product(is_id: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/catalog/product/{is_id}"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "my-store24.p.rapidapi.com"
        }
...
def get_products_in_category(skip: int, category: str, limit: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/catalog/category/{category}/products"
...
def me(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/auth/me"
    querystring = {}
...
def get_categories(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/catalog/categories"
    querystring = {}
...
def get_products(limit: int, skip: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/catalog/products"
...
def get_user_orders(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/order/my"
    querystring = {}
...
def get_order(is_id: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://my-store24.p.rapidapi.com/order/{is_id}"
    querystring = {}
