...
def getpetbyid(petid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Returns a single pet"
    
    """
    url = f"https://pet_test_v1.p.rapidapi.com/pet/vilas1/{petid}"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "pet_test_v1.p.rapidapi.com"
        }
...
def logoutuser(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://pet_test_v1.p.rapidapi.com/user/logout"
    querystring = {}
...
def getuserbyname(username: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://pet_test_v1.p.rapidapi.com/user/{username}"
    querystring = {}
...
def loginuser(username: str, password: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://pet_test_v1.p.rapidapi.com/user/login"
...
def getinventory(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://pet_test_v1.p.rapidapi.com/store/inventory"
    querystring = {}
...
def getorderbyid(orderid: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://pet_test_v1.p.rapidapi.com/store/order/{orderid}"
    querystring = {}
