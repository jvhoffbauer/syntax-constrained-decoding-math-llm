...
def get_news_from_a_specific_source(newspaperid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://ukraine-russia-war-news.p.rapidapi.com/news/{newspaperid}"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "ukraine-russia-war-news.p.rapidapi.com"
        }
...
def get_all_news(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Get the latest news from all the sources this API can fetch for you."
    
    """
    url = f"https://ukraine-russia-war-news.p.rapidapi.com/news"
    querystring = {}
