...
def get_individual_news_source(newspaperid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Get climate news from specific news source"
    
    """
    url = f"https://climate-change-api29.p.rapidapi.com/news/{newspaperid}"
    querystring = {}
...
def get_all_climate_change_news(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "This endpoint returns back all news about the climate changes all over the world"
    
    """
    url = f"https://climate-change-api29.p.rapidapi.com/news"
    querystring = {}
