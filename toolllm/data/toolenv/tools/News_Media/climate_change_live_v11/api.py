...
def get_individual_source_news(newspaperid: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "Climate Change news from speceific news source"
    
    """
    url = f"https://climate-change-live39.p.rapidapi.com/news/{newspaperid}"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "climate-change-live39.p.rapidapi.com"
        }
...
def get_all_climate_change_news(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://climate-change-live39.p.rapidapi.com/news"
    querystring = {}
