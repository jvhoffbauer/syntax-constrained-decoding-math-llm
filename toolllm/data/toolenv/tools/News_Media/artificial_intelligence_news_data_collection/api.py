...
def search_term(q: str, tsi: int=1677067077000, ts: int=1675159335000, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "search term"
    tsi: This is the final time delimiter in Unix time (miliseconds)
...
1 month ago by default
    ...
    """
    url = f"https://artificial-intelligence-news-data-collection.p.rapidapi.com/"
    querystring = {'q': q, }
    if tsi:
        querystring['tsi'] = tsi
    if ts:
    ...
    headers = {
            ...
            "X-RapidAPI-Host": "artificial-intelligence-news-data-collection.p.rapidapi.com"
        }
