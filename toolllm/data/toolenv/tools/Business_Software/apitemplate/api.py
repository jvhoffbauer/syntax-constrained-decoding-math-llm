...
def list_objects(template_id: str='00377b2b1e0ee394', limit: str='300', offset: str='0', toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://apitemplate1.p.rapidapi.com/v2/list-objects"
    querystring = {}
    if template_id:
...
def delete_object(transaction_ref: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://apitemplate1.p.rapidapi.com/v2/delete-object"
...
def list_templates(format: str='JPEG', offset: str='0', limit: str='300', toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://apitemplate1.p.rapidapi.com/v2/list-templates"
    querystring = {}
    if format:
