...
def getmetadataaboutaspecficfile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/me/storage/files/$FILE_ID/"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "kloudless-activity-monitoring.p.rapidapi.com"
        }
...
def get_5_searchforyourfile(parents: int, page_size: int, page: int, lang: str, q: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Terms to search cloud storage for.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/search/"
    querystring = {'parents': parents, 'page_size': page_size, 'page': page, 'lang': lang, 'q': q, }
...
def getpropertiesforallservices(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/public/services/"
    querystring = {}
...
def getpermissionsforafile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/permissions/"
    querystring = {}
...
def getathumbnailforagivenfile(size: int, image_format: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
String specifier for thumbnail format 'png' or 'jpeg'.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/thumbnail/"
    querystring = {'size': size, 'image_format': image_format, }
...
def getpropertiesforafile(active: int, page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Page to return. `page_size` will set the number of objects returned on each page.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/properties"
    querystring = {'active': active, 'page_size': page_size, 'page': page, }
...
def getpermissionsforafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/permissions/"
    querystring = {}
...
def retrievetaskstatus(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/me/tasks/$TASK_ID"
    querystring = {}
...
def getpropertiesforoneservice(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/public/services/$SERVICE_ID"
    querystring = {}
...
def get_1_getalistofitemsintherootfolder(page_size: int, recursive: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Which page of items to retrieve.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/folders/root/contents/"
...
def retrievelatestcursor(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/events/latest"
    querystring = {}
...
A page number within the paginated result set.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/links"
...
def retrieveanevent(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events/$EVENT_ID"
    querystring = {}
...
def getinfoaboutaspecificaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me"
    querystring = {}
...
def getalistofallaccounts(page_size: int, page: int, enabled: int, admin: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Retrieves only admin/non-admin accounts, if present.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/"
    querystring = {'page_size': page_size, 'page': page, 'enabled': enabled, 'admin': admin, }
...
def retrieveacalendar(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID"
    querystring = {}
...
def linkstothefolderattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/links/"
    querystring = {}
...
def listallcalendars(page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "The response contains the following information:
...
Page to return. Do not provide a page parameter when retrieving the first page. To retrieve pages after the first page, set page to the value of next_page found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/cal/calendars"
...
def get_2_downloadafile_scontents(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/contents/"
    querystring = {}
...
def listevents(end: int, page: int, start: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    "The response contains the following information:
...
ISO 8601 timestamp indicating the start of the range of events to retrieve, by event start time. The default value is the start of Unix Epoch Time (`1970-01-01T00:00:00Z`).
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events"
    querystring = {'end': end, 'page': page, 'start': start, }
...
def linkstothefileattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/links/"
    querystring = {}
...
Number of results to return per page.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/quota/"
...
def getalistofitemsinafolder(recursive: int, page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Which page of items to retrieve.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/contents/"
...
def listallcontacts(page_size: int, page: int, account: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Filter by associated `account_id`. Note: this is only supported in `hubspot`
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/contacts/"
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/leads/"
    querystring = {'page_size': page_size, 'page': page, }
...
def retrievealead(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/leads/$LEAD_ID/"
    querystring = {}
...
def retrieveacampaign(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/campaigns/$CAMPAIGN_ID/"
    querystring = {}
...
def retrieveanopportunity(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/opportunities/$OPPORTUNITY_ID/"
    querystring = {}
...
def retrieveacontact(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/contacts/$CONTACT_ID/"
    querystring = {}
...
def getmetadataaboutafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/"
    querystring = {}
...
def retrieveanobject(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/objects/$OBJECT_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/campaigns/"
    querystring = {'page_size': page_size, 'page': page, }
...
def retrieveanaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/accounts/$ACCOUNT_ID/"
    querystring = {}
...
Filter by associated `account_id`. Note: this is only supported in `hubspot`
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/opportunites/"
    querystring = {'page_size': page_size, 'page': page, 'account': account, }
...
Retrieves only an active/inactive link, if present.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/storage/links/$LINK_ID/"
...
Default: 100
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/objects/"
    querystring = {'page': page, 'page_size': page_size, }
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/tasks/"
    querystring = {'page_size': page_size, 'page': page, }
...
def get_3_enableeventsendpoint(is_from: int, page_size: int, until: int, cursor: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
In addition, the latest `upstream_cursor` can be provided as a cursor to retrieve any events after that point in the event stream.
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/events"
    querystring = {'from': is_from, 'page_size': page_size, 'until': until, 'cursor': cursor, }
...
def retrieveatask(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/tasks/$TASK_ID/"
    querystring = {}
...
def listallaccounts(page: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Default: 100
    ...
    """
    url = f"https://kloudless-activity-monitoring.p.rapidapi.com/accounts/me/crm/accounts"
    querystring = {'page': page, 'page_size': page_size, }
