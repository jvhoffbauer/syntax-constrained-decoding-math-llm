...
def get_2_downloadafile_scontents(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/contents/"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "kloudless-email.p.rapidapi.com"
        }
...
An ISO-8601 string specifying the latest time prior to which to return events (exclusive). Must be used along with `from`. Non-overlapping queries can be performed since the event times are in the range [`from`, `until`). Future cursor values returned are limited in range to the `until` value provided in the first request.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/events"
...
def retrievetaskstatus(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/me/tasks/$TASK_ID"
    querystring = {}
...
def getpermissionsforafile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/permissions/"
    querystring = {}
...
def getmetadataaboutafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/"
    querystring = {}
...
List all contents within this folder.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/folders/root/contents/"
...
def getpermissionsforafolder(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/permissions/"
    querystring = {}
...
Retieve only active or only inactive links if present.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/properties"
...
def getinfoaboutaspecificaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me"
    querystring = {}
...
def getalistofallaccounts(enabled: int, admin: int, page_size: int, page: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Page to return. page_size number of objects will be returned on each page. By default, the first page is returned. The page parameter can be used to request further objects.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/"
    querystring = {'enabled': enabled, 'admin': admin, 'page_size': page_size, 'page': page, }
...
def getpropertiesforallservices(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/public/services/"
    querystring = {}
...
def getalistofitemsinafolder(recursive: int, page: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Number of items to return per page.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/contents/"
    querystring = {'recursive': recursive, 'page': page, 'page_size': page_size, }
...
Retrieves only an active/inactive link, if present.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/links/$LINK_ID/"
...
def get_5_searchforyourfile(parents: int, lang: str, page_size: int, page: int, q: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Terms to search cloud storage for.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/search/"
    querystring = {'parents': parents, 'lang': lang, 'page_size': page_size, 'page': page, 'q': q, }
...
def getpropertiesforoneservice(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/public/services/$SERVICE_ID"
    querystring = {}
...
def retrievelatestcursor(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/events/latest"
    querystring = {}
...
Number of results to return per page.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/quota/"
...
def linkstothefileattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/links/"
    querystring = {}
...
def linkstothefolderattheservicelevel(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/folders/$FOLDER_ID/links/"
    querystring = {}
...
def listlinkscreatedforthisaccount(active: int, page: int, ordering: int, page_size: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
...
Number of results to return per page.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/links"
    querystring = {'active': active, 'page': page, 'ordering': ordering, 'page_size': page_size, }
...
ISO 8601 timestamp indicating the end of the range of events to retrieve, by event end time. Required by Outlook Calendar. The default value is the current UTC time.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events"
...
def retrieveanevent(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID/events/$EVENT_ID"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/leads/"
    querystring = {'page': page, 'page_size': page_size, }
...
def retrievealead(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/leads/$LEAD_ID/"
    querystring = {}
...
def retrieveanobject(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/objects/$OBJECT_ID/"
    querystring = {}
...
String specifier for thumbnail format 'png' or 'jpeg'.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/storage/files/$FILE_ID/thumbnail/"
...
def retrieveanopportunity(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/opportunities/$OPPORTUNITY_ID/"
    querystring = {}
...
def retrieveacalendar(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/cal/calendars/$CALENDAR_ID"
    querystring = {}
...
Default: 100
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/contacts/"
...
def getmetadataaboutaspecficfile(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/me/storage/files/$FILE_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/opportunites/"
...
def retrieveanaccount(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/accounts/$ACCOUNT_ID/"
    querystring = {}
...
Page to return. Do not provide a page parameter when retrieving the first page. To retrieve pages after the first page, set page to the value of next_page found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/cal/calendars"
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/campaigns/"
    querystring = {'page_size': page_size, 'page': page, }
...
def retrieveatask(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/tasks/$TASK_ID/"
    querystring = {}
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/tasks/"
    querystring = {'page_size': page_size, 'page': page, }
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/accounts"
    querystring = {'page_size': page_size, 'page': page, }
...
Page to return. Do not provide a `page` parameter when retrieving the first page. To retrieve pages after the first page, set `page` to the value of `next_page` found in the previous page of data retrieved.
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/objects/"
    querystring = {'page_size': page_size, 'page': page, }
...
def retrieveacontact(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/contacts/$CONTACT_ID/"
    querystring = {}
...
def retrieveacampaign(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://kloudless-email.p.rapidapi.com/accounts/me/crm/campaigns/$CAMPAIGN_ID/"
    querystring = {}
