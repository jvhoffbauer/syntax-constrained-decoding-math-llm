...
def sentiment_analysis(text: str, lang: str=None, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    """
    ...
    """
    url = f"https://multi-lingual-sentiment-analysis.p.rapidapi.com/sentiment"
