...
def get_categories(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/catalog/categories"
    querystring = {}
    
    headers = {
            "X-RapidAPI-Key": toolbench_rapidapi_key,
            "X-RapidAPI-Host": "onboarding-project9044.p.rapidapi.com"
        }
...
def me(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/auth/me"
    querystring = {}
...
def get_products(skip: int, limit: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/catalog/products"
...
def get_product(is_id: int, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/catalog/product/{is_id}"
    querystring = {}
...
def get_user_orders(toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/order/my"
    querystring = {}
...
def get_products_in_category(limit: int, skip: int, category: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/catalog/category/{category}/products"
...
def get_order(is_id: str, toolbench_rapidapi_key: str='088440d910mshef857391f2fc461p17ae9ejsnaebc918926ff'):
    ...
    """
    url = f"https://onboarding-project9044.p.rapidapi.com/order/{is_id}"
    querystring = {}
